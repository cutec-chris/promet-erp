...
type
  ...
  TAbstractDBDataset2 = class(TBaseObject)
  private
    FChanged: Boolean;
    FDoChange:Integer;
    FId: Int64;
  ...
  public
    ...
    property Parent : TAbstractDBDataset2 read FParent;
...
procedure TAbstractDBDataset2.FilterEx(aFilter: string; aLimit: Integer;
...
procedure TAbstractDBDataset2.Filter(aFilter: string; aLimit: Integer);
begin
...
procedure TAbstractDBDataset2.FillDefaults(aDataSet: TDataSet);
begin
end;

procedure TAbstractDBDataset2.SetDisplayLabels(aDataSet: TDataSet);
begin
end;

procedure TAbstractDBDataset2.DisableChanges;
begin
  inc(FDoChange);
end;

procedure TAbstractDBDataset2.EnableChanges;
begin
  if FDoChange > 0 then
    dec(FDoChange);
end;
...
function TAbstractDBDataset2.CreateTable: Boolean;
var
  aSQL: String;
  i: Integer;
...
function TAbstractDBDataset2.CheckTable: Boolean;
var
  i: Integer;
  aIndexes: TStrings;
begin
...
function TAbstractDBDataset2.AlterTable: Boolean;
var
  i: Integer;
  aSQL: String;
  tmpSize: Integer;
...
function TAbstractDBDataset2.CheckForInjection(aQuery: string): Boolean;
begin
  Result := False;
end;

function TAbstractDBDataset2.GetCaption: string;
begin
end;
function TAbstractDBDataset2.GetCanEdit: Boolean;
begin
  Result := Assigned(Self) and (Self is TAbstractDBDataset2) and Assigned(fdataSet) and (FDataSet.State = dsEdit) or (FDataSet.State = dsInsert);
end;
...
function TAbstractDBDataset2.GetConnection: TComponent;
begin
end;
function TAbstractDBDataset2.GetFilter: string;
begin
  result := '';
  if not Assigned(DataSet) then exit;
end;
function TAbstractDBDataset2.GetFRows: Integer;
begin
  result := -1;
  if not Assigned(DataSet) then exit;
end;
...
function TAbstractDBDataset2.GetLimit: Integer;
begin
  result := -1;
  if not Assigned(DataSet) then exit;
end;

function TAbstractDBDataset2.GetIsReadOnly: Boolean;
begin
end;

function TAbstractDBDataset2.GetSortDirection: TSortDirection;
begin
  if not Assigned(DataSet) then exit;
end;

function TAbstractDBDataset2.GetSortFields: string;
begin
  if not Assigned(DataSet) then exit;
end;

function TAbstractDBDataset2.GetState: TDataSetState;
begin
end;

function TAbstractDBDataset2.GetTableName: string;
begin
  Result := FTableName;
end;
...
procedure TAbstractDBDataset2.SetFilter(AValue: string);
begin
  if GetFilter = AValue then exit;
end;
procedure TAbstractDBDataset2.SetFRows(AValue: Integer);
begin
end;

procedure TAbstractDBDataset2.SetLimit(AValue: Integer);
begin
end;

procedure TAbstractDBDataset2.SetIsReadOnly(AValue: Boolean);
begin
end;

procedure TAbstractDBDataset2.SetSortDirection(AValue: TSortDirection);
begin
  if not Assigned(DataSet) then exit;
end;

procedure TAbstractDBDataset2.SetSortFields(AValue: string);
begin
  if not Assigned(DataSet) then exit;
end;
...
procedure TAbstractDBDataset2.DefineDefaultFields(aDataSet: TDataSet;
  HasMasterSource: Boolean);
begin
end;

procedure TAbstractDBDataset2.DefineUserFields(aDataSet: TDataSet);
begin
end;
