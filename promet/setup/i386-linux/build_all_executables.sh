...
lazbuild -q -r ../../source/statistics/statistics.lpi  >> scompile-$2.log
...
lazbuild -q -r ../../source/tools/cmdwizardmandant.lpi  >> scompile-$2.log
...
lazbuild -q ../../source/tools/processmanager.lpi  >> scompile-$2.log
lazbuild -q ../../source/tools/processdaemon.lpi  >> scompile-$2.log
