...
strip --strip-all ../../output/$2-darwin/tools/pop3receiver
...
strip --strip-all ../../output/$2-darwin/tools/rssreceiver
...
strip --strip-all ../../output/$2-darwin/tools/smtpsender
