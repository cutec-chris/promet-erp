...
rm -f -r ../source/base/base_calendar/lib
rm -f -r ../source/base/base_documents/lib
rm -f -r ../source/base_erp/lib
rm -f -r ../source/base/base_messaging/lib
rm -f -r ../source/base/base_ocr/lib
rm -f -r ../source/base/base_office/lib
...
rm -f -r ../source/base/base_frames/lib
rm -f -r ../source/base/base_forms/lib
rm -f -r ../source/base/base_inet/lib
rm -f -r ../source/base/base_docmanage/lib
