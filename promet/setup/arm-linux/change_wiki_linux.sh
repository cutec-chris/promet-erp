...
Date=`date`
ToolsRpm32Size=$(ls -s --block-size=1048576 "../output/promet-erp-tools-$(echo $Version)-2.armhf.rpm" | cut -d' ' -f1)
ToolsDeb32Size=$(ls -s --block-size=1048576 "../output/promet-erp-tools_$(echo $Version)_armhf-gtk2.deb" | cut -d' ' -f1)
