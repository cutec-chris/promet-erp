...
lazbuild $Params -B ../../source/sync/sync_db.lpi  >> scompile-$2-tools.log
...
lazbuild $Params ../../source/tools/checkout.lpi  >> scompile-$2-tools.log
echo "compiling processmanager..."  >> scompile-$2-tools.log
lazbuild $Params ../../source/tools/processmanager.lpi  >> scompile-$2-tools.log
echo "compiling processdaemon..."  >> scompile-$2-tools.log
lazbuild $Params ../../source/tools/processdaemon.lpi  >> scompile-$2-tools.log
grep -w "Error:" scompile-$2-tools.log
...
lazbuild $Params ../../source/webservers/mta.lpi  >> scompile-$2-web.log
