...
[Components]
Name: "server"; Description: "Datenbankserver"; Types: full custom
...
[Run]
Filename: "{tmp}\unzip.exe"; Parameters: "{tmp}\*.zip -d {app}"; Flags: shellexec; StatusMsg: "Installiere Promet-ERP Server Komponenten...";
