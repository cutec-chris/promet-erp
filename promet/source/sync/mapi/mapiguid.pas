...
const
  //KB331583
  PS_INTERNET_HEADERS : TGUID = '{00020386-0000-0000-C000-000000000046}';
  strPS_INTERNET_HEADERS = '{00020386-0000-0000-C000-000000000046}';
...
const
  ...
  IID_IMessageRaw : TGUID = '{0002038A-0000-0000-C000-000000000046}';
  strIID_IMessageRaw = '{0002038A-0000-0000-C000-000000000046}';
...
const
  PSETID_Common : TGUID = '{00062008-0000-0000-C000-000000000046}';
  PSETID_Address : TGUID = '{00062004-0000-0000-C000-000000000046}';
  PSETID_Appointment : TGUID = '{00062002-0000-0000-C000-000000000046}';
  PSETID_Meeting : TGUID = '{6ED8DA90-450B-101B-98DA-00AA003F1305}';
  PSETID_Log : TGUID = '{0006200A-0000-0000-C000-000000000046}';
  PSETID_Messaging : TGUID = '{41F28F13-83F4-4114-A584-EEDB5A6B0BFF}';
  PSETID_Note : TGUID = '{0006200E-0000-0000-C000-000000000046}';
  PSETID_PostRss : TGUID = '{00062041-0000-0000-C000-000000000046}';
  PSETID_Task : TGUID = '{00062003-0000-0000-C000-000000000046}';
  PSETID_UnifiedMessaging : TGUID = '{4442858E-A9E3-4E80-B900-317A210CC15B}';
  PSETID_AirSync : TGUID = '{71035549-0739-4DCB-9163-00F0580DBBDF}';
  PSETID_Sharing : TGUID = '{00062040-0000-0000-C000-000000000046}';
  PSETID_CalendarAssistant : TGUID = '{11000E07-B51B-40D6-AF21-CAA85EDAB1D0}';
implementation
