...
const
  MAPI_ONE_OFF_UID : array[0..15] of byte =
    (
...
const
  ...
  ;
  PT_STRING8 = ULONG(30)               { Null terminated 8-bit character AnsiString }
  ;
  PT_UNICODE = ULONG(31)               { Null terminated Unicode AnsiString }
  ;
  ...
  ;
  PT_PTR			= ULONG (259) 	//* Pointer Variable, scales to the platform */
  ;
...
(*
 *  The type of a MAPI-defined AnsiString property is indirected, so
 *  that it defaults to Unicode AnsiString on a Unicode platform and to
 ...
 *  dereferenced to obtain the AnsiString pointer.
 *)
  ...
  T__UPV =     
    record
      case Integer of
        ...
        29 :
          (
            lpv : Pointer;               { case PT_NULL, PT_OBJECT (no usable value) }
          );
    end;
...
const
  ...
  //Outlook 2007
  fnevIndexing		= $00010000;

  INDEXING_SEARCH_OWNER = 1;
...
type
  ...
  TNEWMAIL_NOTIFICATION =     
    record
      ...
      ulFlags : ULONG;                 { 0 or MAPI_UNICODE }
      lpszMessageClass : PAnsiChar;        { message class (UNICODE or string8) }
...
const
  ...
  ITEMPROC_FORCE = ULONG($00000800);
  NON_EMS_XP_SAVE = ULONG($00001000);
  SPAMFILTER_ONSAVE = ULONG($00000080);
  ...
  IMAPIProp =
    ...
    [strIID_IMAPIProp]
      ...
      function GetProps (lpPropTagArray : PSPropTagArray; ulFlags : ULONG; 
        out lpcValues : ULONG;
        out lppPropArray : PSPropValue) : HResult; stdcall;
      function GetPropList (ulFlags : ULONG;
        out lppPropTagArray : PSPropTagArray) : HResult; stdcall;
      ...
      function CopyTo (ciidExclude : ULONG; const rgiidExclude : TIID; 
        ...
        var lppProblems : PSPropProblemArray) : HResult; stdcall;
      function CopyProps (lpIncludeProps : PSPropTagArray; ulUIParam : ULONG_PTR;
      ...
      function GetNamesFromIDs (var lppPropTags : PSPropTagArray; 
        lpPropSetGuid : PGUID; ulFlags : ULONG; out lpcPropNames : ULONG;
        out lpppPropNames : PMAPINAMEID) : HResult; stdcall;
      function GetIDsFromNames (cPropNames : ULONG; var lppPropNames : PMAPINAMEID; 
        ulFlags : ULONG; out lppPropTags : PSPropTagArray) : HResult; stdcall;
    end;
...
const
  ...
  //Outlook 2007
  FL_PREFIX_ON_ANY_WORD 	= $00000010;
  FL_PHRASE_MATCH		    = $00000020;
...
const
  ...
  RES_COUNT		= ULONG($0000000B);
  RES_ANNOTATION	= ULONG($0000000C);
      ...
      res :         
        record
          case Integer of
            ...
            12 :
              (
                resCount : TSCountRestriction;
              );
            13 :
              (
                resAnnotation : TSAnnotationRestriction;
              );
      end;
    end;
...
type
  IMAPITable =
    ...
    [strIID_IMAPITable]
      ...
      function GetStatus (out lpulTableStatus : ULONG; out lpulTableType : ULONG) : HResult; stdcall;
      function SetColumns (lpPropTagArray : PSPropTagArray; ulFlags : ULONG) : HResult; stdcall;
      function QueryColumns (ulFlags : ULONG; out lpPropTagArray : PSPropTagArray) : HResult; stdcall;
      function GetRowCount (ulFlags : ULONG; out lpulCount : ULONG) : HResult; stdcall;
      function SeekRow (bkOrigin : TBOOKMARK; lRowCount : Longint; out lplRowsSought : Longint) : HResult; stdcall;
      function SeekRowApprox (ulNumerator : ULONG; ulDenominator : ULONG) : HResult; stdcall;
      function QueryPosition (out lpulRow : ULONG; out lpulNumerator : ULONG;
        out lpulDenominator : ULONG) : HResult; stdcall;
      ...
      function QuerySortOrder (out lppSortCriteria : PSSortOrderSet) : HResult; stdcall;
      function QueryRows (lRowCount : Longint; ulFlags : ULONG; 
        out lppRows : PSRowSet) : HResult; stdcall;
...
type
  IMAPIStatus =
    interface(IMAPIProp)
    [strIID_IMAPIStatus]
      function ValidateState (ulUIParam : ULONG_PTR; ulFlags : ULONG) : HResult; stdcall;
      function SettingsDialog (ulUIParam : ULONG_PTR; ulFlags : ULONG) : HResult; stdcall;
      function ChangePassword (lpOldPass : PAnsiChar; lpNewPass : PAnsiChar; ulFlags : ULONG) : HResult; stdcall;
...
const
  ...
  SEARCH_COMPLETE  = $00001000; // The search results are complete.
  SEARCH_PARTIAL  = $00002000;// The search results are not complete, as only some parts of messages were included.
  SEARCH_STATIC  = $00010000;// The search is static.
  SEARCH_MAYBE_STATIC  = $00020000;// The search is still being evaluated.
  CI_TOTALLY  = $01000000;//  The search is completely done using content indexing.
  CI_WITH_TWIR_RESIDUAL  = $02000000;// The search is mostly done using content indexing.
  TWIR_MOSTLY  = $04000000;// The search is mostly done using store-only search.
  TWIR_TOTALLY  = $08000000;// The search is completely done using store-only search.
  ...
  //Exchange
  CONTENT_INDEXED_SEARCH   = $00010000;// Use content-indexed search exclusively.
  NON_CONTENT_INDEXED_SEARCH   = $00020000;// Never use content-indexed search.
  STATIC_SEARCH  = $00040000;//  Make the search static.
...
const
  ...
  AB_UNICODE_OK	 = ULONG($00000040);
  AB_ANSI_OK	 = ULONG($00000080);
...
type
  IABContainer =
    ...
    [strIID_IABContainer]
      ...
      function CopyEntries (lpEntries : PENTRYLIST; ulUIParam : ULONG_PTR;
...
const
  ...
  MESSAGE_BEST_BODY		= $00000010;
  MESSAGE_SEND_ENTRYID	= $00000020;
  ...
  MSGSTATUS_DRAFT = ULONG($00000100);
  MSGSTATUS_ANSWERED = ULONG($00000200);
...
//* Origin flags. Values 1000-8000 reserved. Zero in these
//  bits implies "local" origin. */

  MSGFLAG_ORIGIN_X400 = ULONG($00001000);
  MSGFLAG_ORIGIN_INTERNET = ULONG($00002000);
  MSGFLAG_ORIGIN_MISC_EXT = ULONG($00008000);

//* Following flag is set only in the message flags member of the
//   new mail notification header to figure out whether the transport
//   was EMS or other (e.g., POP)*/
  MSGFLAG_OUTLOOK_NON_EMS_XP = ULONG($00010000);
...
const
  ...
  STORE_HTML_OK			 = ULONG($00010000);
  STORE_ANSI_OK			 = ULONG($00020000);
  STORE_UNICODE_OK		 = ULONG($00040000);
  STORE_LOCALSTORE		 = ULONG($00080000);
  STORE_SHARED_FOLDERS	         = ULONG($00100000);

  //Outlook 2007
  STORE_FULLTEXT_QUERY_OK = $02000000;
  STORE_FILTER_SEARCH_OK  = $04000000;
  STORE_PUSHER_OK         = $00800000;

  //http://blogs.msdn.com/stephen_griffin/default.aspx
  STORE_ITEMPROC = $00200000;
 ...
 *)
  ...
  //PR_DISPLAY_TYPE_EX.
  DTE_FLAG_REMOTE_VALID	= $80000000;
  DTE_FLAG_ACL_CAPABLE    = $40000000;
  DTE_MASK_REMOTE        	= $0000ff00;
  DTE_MASK_LOCAL        	= $000000ff;

  //DTE_IS_REMOTE_VALID(v)	(!!((v) & DTE_FLAG_REMOTE_VALID))
  //DTE_IS_ACL_CAPABLE(v)	(!!((v) & DTE_FLAG_ACL_CAPABLE))
  //DTE_REMOTE(v)		(((v) & DTE_MASK_REMOTE) >> 8)
  //DTE_LOCAL(v)		((v) & DTE_MASK_LOCAL)

  DT_ROOM			 = $00000007;
  DT_EQUIPMENT		 = $00000008;
  DT_SEC_DISTLIST		 = $00000009;
...
type
  TACCELERATEABSDI = function (ulUIParam : ULONG_PTR; lpvmsg : Pointer) : BOOL; stdcall;
...
type
  TDISMISSMODELESS = procedure (ulUIParam : ULONG_PTR; lpvContext : Pointer); stdcall;
...
type
  PFNBUTTON = function (ulUIParam : ULONG_PTR; lpvContext : Pointer;
...
type
  TADRPARM =     
    record
      ...
      lpReserved : Pointer;
      ulHelpContext : ULONG;
      lpszHelpFileName : PAnsiChar;
      lpfnABSDI : PFNABSDI;
      lpfnDismiss : PFNDISMISS;
      lpvDismissContext : Pointer;
      lpszCaption : PAnsiChar;
      lpszNewEntryTitle : PAnsiChar;
      lpszDestWellsTitle : PAnsiChar;
      cDestFields : ULONG;
      nDestFieldFocus : ULONG;
      lppszDestTitles : ^PAnsiChar;
      lpulDestComps : ^ULONG;
...
type
  IMAPIControl =
    ...
    [strIID_IMAPIControl]  
      function GetLastError (hResult : HResult; ulFlags : ULONG;
        var lppMAPIError : PMAPIERROR) : HResult; stdcall;
      function Activate (ulFlags : ULONG; ulUIParam : ULONG_PTR) : HResult; stdcall;
  ...
  IMAPIFolder =
    ...
    [strIID_IMAPIFolder]
      ...
      function CopyMessages (lpMsgList : PENTRYLIST; const lpInterface : TIID;
        lpDestFolder : Pointer; ulUIParam : ULONG_PTR; lpProgress : IMAPIProgress;
        ulFlags : ULONG) : HResult; stdcall;
      function DeleteMessages (lpMsgList : PENTRYLIST; ulUIParam : ULONG_PTR;
        lpProgress : IMAPIProgress; ulFlags : ULONG) : HResult; stdcall;
      function CreateFolder (ulFolderType : ULONG; lpszFolderName : PAnsiChar; 
        lpszFolderComment : PAnsiChar; const lpInterface : TIID; ulFlags : ULONG; 
        out lppFolder : IMAPIFolder) : HResult; stdcall;
      function CopyFolder (cbEntryID : ULONG; lpEntryID : PENTRYID;
        const lpInterface : TIID; lpDestFolder : Pointer; lpszNewFolderName : PAnsiChar; 
        ulUIParam : ULONG_PTR; lpProgress : IMAPIProgress; ulFlags : ULONG) : HResult; stdcall;
      function DeleteFolder (cbEntryID : ULONG; lpEntryID : PENTRYID; 
        ulUIParam : ULONG_PTR; lpProgress : IMAPIProgress; ulFlags : ULONG) : HResult; stdcall;
      function SetReadFlags (lpMsgList : PENTRYLIST; ulUIParam : ULONG_PTR;
        lpProgress : IMAPIProgress; ulFlags : ULONG) : HResult; stdcall;
      ...
      function EmptyFolder (ulUIParam : ULONG_PTR; lpProgress : IMAPIProgress;
        ulFlags : ULONG) : HResult; stdcall;
    end;
  ...
  IMsgStore =
    ...
    [strIID_IMsgStore]  
      function Advise (cbEntryID : ULONG; lpEntryID : PENTRYID; ulEventMask : ULONG;
        lpAdviseSink : IMAPIAdviseSink; var lpulConnection : ULONG_PTR) : HResult; stdcall;
      function Unadvise (ulConnection : ULONG_PTR) : HResult; stdcall;
      ...
      function SetReceiveFolder (lpszMessageClass : PAnsiChar; ulFlags : ULONG; 
        cbEntryID : ULONG; lpEntryID : PENTRYID) : HResult; stdcall;
      function GetReceiveFolder (lpszMessageClass : PAnsiChar; ulFlags : ULONG; 
        out lpcbEntryID : ULONG; out lppEntryID : PENTRYID;
        out lppszExplicitClass : PAnsiChar) : HResult; stdcall;
  ...
  IMessage =
    ...
    [strIID_IMessage]
      ...
      function CreateAttach (const lpInterface : TIID; ulFlags : ULONG; 
        out lpulAttachmentNum : ULONG; out lppAttach : IAttach) : HResult; stdcall;
      function DeleteAttach (ulAttachmentNum : ULONG; ulUIParam : ULONG_PTR;
        lpProgress : IMAPIProgress; ulFlags : ULONG) : HResult; stdcall;
...
type
  ...
  IProviderAdmin =
    ...
    [strIID_IProviderAdmin]
      ...
      function CreateProvider (lpszProvider : PAnsiChar; cValues : ULONG;
        lpProps : PSPropValue; ulUIParam : ULONG_PTR; ulFlags : ULONG;
...
const
  //New Outlook 11 flags

  //* Flag to keep calls from redirecting in cached mode */
  MAPI_NO_CACHE			 = $00000200;
  //* Flag to say, "Yeah, I know what I'm doing, go ahead
  // and turn a header into a full item synchronously */
  MAPI_SYNCH_DOWNLOAD_OK	 = $00000400;
  //* Flag to keep calls from redirecting in cached mode */
  MAPI_CACHE_ONLY		 = $00004000;
  MDB_ONLINE = $00000100;
  MDB_OST_LOGON_UNICODE = $00000800;
  MDB_OST_LOGON_ANSI = $00001000;
...
const
  ...
  MAPI_NATIVE_BODY  = $00010000;

  MAPI_NATIVE_BODY_TYPE_RTF = $00000001;
  MAPI_NATIVE_BODY_TYPE_HTML = $00000002;
  MAPI_NATIVE_BODY_TYPE_PLAINTEXT = $00000004;
...
type
  RTFSYNCINFO = record
    ...
    lBodyCount : ULONG;
    lPrefixCount : ULONG;
    lTrailingCount : ULONG;
    szBodyTag : array[0..cchBodyTagMax + 2 - 1] of AnsiChar;
  end;
