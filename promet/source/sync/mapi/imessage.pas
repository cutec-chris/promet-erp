...
type
  TMSGCALLRELEASE = procedure (ulCallerData : ULONG_PTR; lpMessage : pointer{MapiDefs.IMessage}); stdcall;
  PMSGCALLRELEASE = ^TMSGCALLRELEASE;
...
//load these dynamically!!! - moved to MAPIUtil
