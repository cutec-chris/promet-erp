...
zip $basedir/promet/setup/output/$BUILD_VERSION/tools_$TARGET_CPU-$TARGET_OS-$BUILD_VERSION.zip checkin$TARGET_EXTENSION checkout$TARGET_EXTENSION tools/processdaemon$TARGET_EXTENSION tools/processmanager$TARGET_EXTENSION
cd $basedir
