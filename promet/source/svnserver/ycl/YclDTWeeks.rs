...
{**************************************************************************************************}
  ...
  SInvalidWeekDef = '%.8x is not a valid week definition.';
  SInvalidWeekDate = '%.4d-W%.2d-%.1d is not a valid week date.';
  SInvalidUKTaxWeekDate = '%.4d-W%.2d-%.1d is not a valid UK Inland Revenue Tax Weeks date.';
