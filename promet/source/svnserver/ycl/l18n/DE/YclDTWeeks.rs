...
{  Y core library (Ycl)                                                                            }
{                                                                                                  }
{  YclDTWeeks - date / time - week functions - resource strings                                    }
{                                                                                                  }
...
{                                                                                                  }
{  The Original Code is: YclDTWeeks.rs.                                                            }
...
{**************************************************************************************************}
  ...
  SInvalidWeekDef = '%.8x ist keine gültige Wochen-Definition.';
  SInvalidWeekDate = '%.4d-W%.2d-%.1d ist kein gültiges Wochendatum.';
  SInvalidUKTaxWeekDate = '%.4d-W%.2d-%.1d ist kein gültiges UK Inland Revenue Tax Weeks Datum.';
