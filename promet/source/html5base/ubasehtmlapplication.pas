unit ubasehtmlapplication;
{$mode objfpc}{$H+}
interface
uses
  Classes, SysUtils, custhttpapp, uBaseApplication, uBaseDBInterface,
...
var
  aDir: String;
begin
  aDir := GetConfigDir(StringReplace(lowercase(GetAppname),'-','',[rfReplaceAll]));
...
begin
  ...
  Port:=Properties.ReadInteger('PORT',8086);
  Result := True;
end;
